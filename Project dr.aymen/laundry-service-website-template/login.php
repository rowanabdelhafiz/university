            ...
            <div class="row">
                <div class="col-12">
                    <div class="contact-form">
                        <div id="success"></div>
                        <form method="POST" action="login_check.php" method="POST" class="login-email">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="control-group">
                                        <input type="id" placeholder="Id" name="id" required class="form-control" required="required" data-validation-required-message="Please enter your id" />
